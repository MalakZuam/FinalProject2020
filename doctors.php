        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <h3 class="menu-title">Requstes</h3><!-- /.menu-title -->
                    <li><a href="add-hotel.php"> <i class="menu-icon fa fa-table"></i>Show Requstes</a></li>

                    <h3 class="menu-title">Advertisements</h3><!-- /.menu-title -->
                    <li><a href="add-hotel.php"> <i class="menu-icon fa fa-table"></i>Show Ads</a></li>
                    <li><a href="add-hotel.php"> <i class="menu-icon fa fa-plus-square"></i>Add Ads</a></li>
